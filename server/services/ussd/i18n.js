...
//UPDATED: server/services/ussd/i18n.js
...
const STRINGS = {
  en: {
    ...
    message_too_short: "Message too short.",
    confirm_prompt: (excerpt) => `Confirm? "${excerpt}..."\n1. Yes, submit\n2. Re-type`,
    // ADDED: new_ticket_category.js and my_tickets.js had zero Swahili support —
    // they were hardcoded English strings that never called t(). These keys
    // give them something to call instead.
    your_tickets: "Your tickets:",
    ticket_line: (i, category, status) => `${i}. ${category} - ${status}`,
  },
  sw: {
    welcome_title: "Jetlink Msaada",
    welcome_menu: "1. Tiketi zangu\n2. Ripoti tatizo\n3. Piga simu\n4. English",
    ...
    message_too_short: "Ujumbe ni mfupi sana.",
    confirm_prompt: (excerpt) => `Thibitisha? "${excerpt}..."\n1. Ndio\n2. Andika upya`,
    // ADDED: Swahili counterparts to the new English keys above.
    your_tickets: "Tiketi zako:",
    ticket_line: (i, category, status) => `${i}. ${category} - ${status}`,
  },
};
